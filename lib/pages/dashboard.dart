...
class _HomeDashboardState extends State<HomeDashboard> {
  ...
  Future<void> _loadPatientData() async {
    try {
      ...
      if (doc.exists) {
        ...
        if (data != null) {
          patientDetails = data;
          print("Fetched patient data: $patientDetails");
  ...
  void _calculateRequirements() {
    try {
      int age = int.tryParse(patientDetails?['age']?.toString() ?? '0') ?? 0;
      ...
      if(weight>50){
        requiredCalories = (30 * weight).clamp(1200, 4000).toInt();
        ...
        requiredCalories = (35 * weight).clamp(1200, 4000).toInt();
        requiredProtein = (weight * 1.5).clamp(50, 200).toInt();
        requiredCarbs=(((requiredCalories??2000)-(requiredProtein??100)*4)/8).toInt();
        requiredFat=(((requiredCalories??2000)-(requiredProtein??100)*4)/18).toInt();
        requiredFiber=(14 * (requiredCalories??2000)/1000).clamp(14,100).toInt();
      ...
      print("Calculated -> Calories: $requiredCalories, Protein: $requiredProtein");
    } catch (e) {
        ...
        child: Column(
          children: [
            ...
            Row(
              ...
              children: [
                _circularProgress("Calories", totalCalories, requiredCalories, Colors.deepOrange),
  ...
  children: [
    ...
    _modernButton(Icons.medication, "Supplements", () {}),
